# ----------------------------------------------------------------- #
#                                                                   #
#   Workflow unit for adaboosted trees regression with              #
...
with settings.context as context:
    ...
    if settings.is_workflow_running_to_train:
        ...
        base_estimator = sklearn.tree.DecisionTreeRegressor(criterion="mse",
                                                            ...
                                                            ccp_alpha=0.0)
        # Initialize
        model = sklearn.ensemble.AdaBoostRegressor(base_estimator=base_estimator,
                                                   n_estimators=50,
                                                   learning_rate=1,
                                                   loss="linear")
        ...
        context.save(model, "adaboosted_tree_regression")
    ...
    # Predict
        ...
        # Restore model
        model = context.load("adaboosted_tree_regression")
